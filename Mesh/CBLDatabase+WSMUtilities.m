...
- (void)setRegistries:(NSMutableDictionary *)registries {
    ...
    objc_setAssociatedObject(self, &kWSMViewRegistries, registries,
...
- (NSMutableDictionary *)registries {
    if (!objc_getAssociatedObject(self, &kWSMViewRegistries)) {
        objc_setAssociatedObject(self, &kWSMViewRegistries, @{}.mutableCopy,
                                 OBJC_ASSOCIATION_RETAIN_NONATOMIC);
    }
...
- (void)setVariables:(NSMutableDictionary *)variables {
    ...
    objc_setAssociatedObject(self, &kWSMViewVariables, variables,
                             OBJC_ASSOCIATION_RETAIN_NONATOMIC);
...
- (NSMutableDictionary *)variables {
    if (!objc_getAssociatedObject(self, &kWSMViewVariables)) {
        objc_setAssociatedObject(self, &kWSMViewVariables, @{}.mutableCopy,
                                 OBJC_ASSOCIATION_RETAIN_NONATOMIC);
    }
...
- (void)setTimers:(NSMutableDictionary *)timers {
    ...
    objc_setAssociatedObject(self, &kWSMViewTimers, timers,
                             OBJC_ASSOCIATION_RETAIN_NONATOMIC);
...
- (NSMutableDictionary *)timers {
    if (!objc_getAssociatedObject(self, &kWSMViewTimers)) {
        objc_setAssociatedObject(self, &kWSMViewTimers, @{}.mutableCopy,
                                 OBJC_ASSOCIATION_RETAIN_NONATOMIC);
    }
