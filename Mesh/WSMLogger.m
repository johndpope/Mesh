...
NSString *const kWSMLogFormatKeyQueue = @"kWSMFormatKeyQueue";
NSString *const kWSMLogFormatKeyFile = @"kWSMFormatKeyFile";
NSString *const kWSMLogFormatKeyFunction = @"kWSMFormatKeyFunction";
